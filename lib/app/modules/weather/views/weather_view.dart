      ...
      body: SafeArea(
        child: GetBuilder<WeatherController>(
          builder: (_) => MyWidgetsAnimator(
            ...
            loadingWidget: () => const Center(child: LoadingIndicator(hasShadow: true)),
            errorWidget: () => ApiErrorWidget(retryAction: () {}),
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        PopupMenuButton<String>(
                          //initialValue: controller.selectedDay,
                          ...
                          itemBuilder: (context) => controller.weatherDetails.forecast.forecastday.map((fd) {
                            return PopupMenuItem<String>(
                              //value: controller.convertDateToDay(fd.date),
                              value: fd.date.convertToDay(),
                              child: Text(
                                //controller.convertDateToDay(fd.date),
                      ...
                      itemBuilder: (context, index) {
                        return AnimatedBuilder(
                          ...
                          builder: (context, child) {
                            double value = 0.0;
                            //double value = index == 1 ? 0.038 : 0.0;
                            ...
                            return Transform.rotate(
                              ...
                              child: WeatherDetailsCard(
                                ...
                                //forecastDay: controller.forecastday,
